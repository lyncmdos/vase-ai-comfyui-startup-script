...
CHECKPOINT_MODELS=(
    ...
    "https://huggingface.co/Phr00t/Qwen-Image-Edit-Rapid-AIO/resolve/main/v18/Qwen-Rapid-AIO-NSFW-v18.safetensors"
)
...
LLM_MODELS=(
    ...
    "https://huggingface.co/unsloth/Qwen3-30B-A3B-Instruct-2507-GGUF/resolve/main/Qwen3-30B-A3B-Instruct-2507-UD-Q6_K_XL.gguf?download=true"
)
DIFFUSION_MODELS=(
